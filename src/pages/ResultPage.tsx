...
export default function ResultPage() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: `I am a ${result.code} - ${result.title}! Take the test to discover yours.`,
  ...
  const copyToClipboard = () => {
    const shareText = `I am a ${result.code} - ${result.title}! Take the test to discover yours.`;
      ...
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
        ...
        <main className="flex-1 flex flex-col items-center justify-center p-4">
          <div className="w-full max-w-3xl">
            ...
            >
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Your Personality Type</h1>
              <p className="text-gray-600 dark:text-gray-300">Here's what we discovered about you</p>
            </motion.div>
